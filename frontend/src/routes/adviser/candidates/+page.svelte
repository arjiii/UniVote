<script>
	...
	async function handleAddCandidate(e) {
		...
		try {
			const finalPosition = newCandidate.position === 'Other' ? customPosition : newCandidate.position;
			if (!finalPosition) {
				errorMessage = 'Please provide a position name.'; isSubmitting = false; return;
			}
